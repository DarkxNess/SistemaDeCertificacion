...
using Aplicacion_web_de_certificacion.Models.AccountViewModels;
...
namespace Aplicacion_web_de_certificacion.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult RegisterAdmin1(string returnUrl = null)
        {
            RegisterViewModel R = new RegisterViewModel();
            R.getRoles(_context);
            ViewData["ReturnUrl"] = returnUrl;
        ...
        public async Task<IActionResult> RegisterAdmin(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("ListarUsers","Users","");
                }
                AddErrors(result);
            }
        ...
        private IActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                return RedirectToAction(nameof(EntidadController.Index), "Entidad");
            }
        }
